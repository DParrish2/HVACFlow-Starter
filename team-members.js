(() => {
  ...
  function ensureStyles(){
    ...
    style.textContent=`
      ...
      .team-actions{display:flex;gap:7px;flex-wrap:wrap}.team-seat-box{display:flex;gap:10px;align-items:end;flex-wrap:wrap}.team-seat-box label{display:flex;flex-direction:column;gap:5px}.team-seat-box input{width:110px}
